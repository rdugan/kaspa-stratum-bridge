...
# few minutes. Can be overridden by the client in the worker field using the
...
# is +/- 5% after 4hrs.  Can be overridden by the client in the worker field 
# using the format <address>.<worker>=<min_diff>+<max_job_rate>
var_diff: true
